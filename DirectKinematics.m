...
x = (sin(theta(5))*(sin(theta(1))*sin(theta(4)) + sin(theta(2) + theta(3))*cos(theta(1))*...
    cos(theta(4))))/50 - (39*sin(theta(1))*sin(theta(4)))/200 - (cos(theta(1))*...
    (21*sin(theta(2) + theta(3)) + 120*sin(theta(2)) + 25))/1000 - (cos(theta(2) + theta(3))*...
    cos(theta(1))*cos(theta(5)))/50 - (39*sin(theta(2) + theta(3))*cos(theta(1))*...
    cos(theta(4)))/200;
y = (39*cos(theta(1))*sin(theta(4)))/200 - (sin(theta(1))*(21*sin(theta(2) + theta(3)) +...
    120*sin(theta(2)) + 25))/1000 - (sin(theta(5))*(cos(theta(1))*sin(theta(4)) - sin(theta(2) + theta(3))*...
    cos(theta(4))*sin(theta(1))))/50 - (cos(theta(2) + theta(3))*cos(theta(5))*sin(theta(1)))/50 -... 
    (39*sin(theta(2) + theta(3))*cos(theta(4))*sin(theta(1)))/200;
z =(21*cos(theta(2) + theta(3)))/1000 + (3*cos(theta(2)))/25 + (39*cos(theta(2) + theta(3))*...
    cos(theta(4)))/200 - (sin(theta(2) + theta(3))*cos(theta(5)))/50 - (cos(theta(2) + theta(3))*...
    cos(theta(4))*sin(theta(5)))/50 + 99/1000;
